public class Pinky extends Ghost implements Comparable<Location>
{
  //private int x;
  //private int y;
  ...
  public Pinky(Location location)
  {
    super(location);
    int xy[] = location.getXY();
    this.x=xy[0];
    this.y=xy[1];
    this.colour=Game.PINK;
    this.direction=1;
  ...
  @Override
    ...
    return "[Pinky:location=" + location.toString() + ", direction=" + direction + ", speed=" + speed + ", moving=" + moving + ", bearing=" + bearing + "]";
  }
