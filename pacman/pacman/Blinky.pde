public class Blinky extends Ghost implements Comparable<Location>
{
  //private int x;
  //private int y;
  ...
  public Blinky(Location location)
  {
    super(location);
    int xy[] = location.getXY();
    this.x=xy[0];
    this.y=xy[1];
    this.colour=Game.RED;
    this.direction=1;
  ...
  @Override
    ...
    return "[Blinky:location=" + location.toString() + ", direction=" + direction + ", speed=" + speed + ", moving=" + moving + ", bearing=" + bearing + "]";
  }
